...
Native schemas 1, 2, and 3 upgrade transactionally to schema 4; pre-native databases and unknown/newer migration ledgers are rejected. Existing migrations 0001–0003 and SHA-256 checksums are immutable.

### Schema 4 upgrade and restore
